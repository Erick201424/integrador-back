...
export interface EventRepository {
    ...
    createEvent(description: string,id_community: number,location: string,date:string,starts_at:string): Promise<Event | null>;
    // updateEvent(id: number, name: string,iduser:number): Promise<Event | null>;
