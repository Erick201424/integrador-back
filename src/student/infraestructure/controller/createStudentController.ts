...
export class CreateStudentController {
    ...
    async execute(req: Request, res: Response) {
        ...
        // Obtener el nombre de la imagen del archivo adjunto
        ...
        try {
            ...
            console.log(name, lastname, phone, gender, email, password, institution_id, career_id, securityQuestion, securityAnswer, url_img);
            ...
            if (createdStudent instanceof Student) {
                return res.status(201).send({
                    ...
                    data: {
                        ...
                        url_img: createdStudent.url_img
                    },
