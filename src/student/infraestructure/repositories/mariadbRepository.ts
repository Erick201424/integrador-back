...
export class MariaDBRepository implements StudentRepository {
    ...
    async createStudent(name: string, lastname: string, phone: string, gender: string, email: string, password: string, institution_id: number, career_id: number, securityQuestion: number, securityAnswer: string, url_img: string): Promise<Student | null | Error> {
        try {
            const sql = "INSERT INTO students (name, lastname, phone, gender, email, password, institution_id, career_id, securityQuestion, securityAnswer, url_img) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            const params: any[] = [name, lastname, phone, gender, email, password, institution_id, career_id, securityQuestion, securityAnswer, url_img];
            console.log(sql, params)
            const result = await query(sql, params);
            console.log(result);

            if (result && result.insertId) {
                const createdStudent = new Student(result.insertId, name, lastname, phone, gender, email, password, institution_id, career_id, securityQuestion, securityAnswer, url_img);
    ...
    async updateStudent(id: number, name?: string, lastname?: string, phone?: string, gender?: string, url_img?: string): Promise<Student | null | Error | string> {
